...
export interface IProduct {
    ...
    status: "published" | "draft" | "scheduled" | string | null;
    visibility: "public" | "hidden" | string | null;
    publishedDate: string | null;     
    hasVariants: boolean | null;
    wGProductCategoryId: number | null;   
}
// ── VARYANT ─────────────────────────────────────────────────────
...
export interface IVariantType {
    id: number;
    name: string;                   
    displayType: "color-swatch" | "button" | "dropdown" | string;
    order: number;
    wGProductId: number;              
}
...
export interface IInvoice {
    ...
    // Ödeme yöntemi
    paymentMethod: "card" | "paypal" | "cod" | string;

    // Kargo
    shippingMethod:  "FREE" | "EXPRESS" | string;
...
export interface IOrder {
    ...
    total: number;
    paymentMethod: "card" | "paypal" | "cod" | string;
    status: "pending" | "inprogress" | "pickups" | "delivered" | "returns" | "cancelled" | string;
...
const customerList = [
  ...
  },
  {
    ...
    email: "robertmcmahon@workgrid.com",
    phone: "786-253-9927",
    date: "12 Jan, 2021",
    status: "Active",
    statusClass: "success",
  },
  {
    ...
    email: "michaelmorris@workgrid.com",
    phone: "805-447-8398",
    date: "19 May, 2021",
    status: "Block",
    statusClass: "danger",
  },
  {
    ...
    email: "kevindawson@workgrid.com",
    phone: "213-741-4294",
    date: "14 Apr, 2021",
    status: "Active",
    statusClass: "success",
  },
  {
    ...
    email: "carolynjones@workgrid.com",
    phone: "414-453-5725",
    date: "07 Jun, 2021",
    status: "Active",
    statusClass: "success",
  ...
  },
  {
    ...
    email: "charleskubik@workgrid.com",
    phone: "231-480-8536",
    date: "25 Sep, 2021",
    status: "Block",
    statusClass: "danger",
  },
  {
    ...
    email: "herbertstokes@workgrid.com",
    phone: "312-944-1448",
    date: "20 Jul, 2021",
    status: "Block",
    statusClass: "danger",
  },
  {
    ...
    email: "timothysmith@workgrid.com",
    phone: "973-277-6950",
    date: "13 Dec, 2021",
    status: "Active",
    statusClass: "success",
  },
  {
    ...
    email: "johnnyevans@workgrid.com",
    phone: "407-645-1767",
    date: "01 Oct, 2021",
    status: "Block",
    statusClass: "danger",

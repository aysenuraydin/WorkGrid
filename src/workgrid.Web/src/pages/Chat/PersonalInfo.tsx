...
const PersonalInfo = ({ show, onCloseClick, currentuser, cuurentiseImg }:{ show:any, onCloseClick:any, currentuser:any, cuurentiseImg:any }) => {
                  ...
                  <Dropdown isOpen={menu1} toggle={() => setMenu1(!menu1)}>
                    ...
                    <DropdownMenu className="dropdown-menu-end">
                      ...
                      <DropdownItem href="#" className="text-danger">
                        <i className="ri-delete-bin-5-line align-bottom text-danger me-2"></i>
                        Sil
                      </DropdownItem>
                    </DropdownMenu>
                  </Dropdown>

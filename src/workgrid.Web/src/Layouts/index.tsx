...
const Layout = (props: any) => {
    ...
    /*
    layout settings
    NOT: changeLayoutMode (dark/light) BURADAN KALDIRILDI.
    Tema artık useThemeMode + TenantDomInjector tarafından yönetiliyor.
    Velzon'un changeLayoutMode'u data-bs-theme'i ezip temayı bozuyordu.
    */
    useEffect(() => {
        if (
            layoutType ||
